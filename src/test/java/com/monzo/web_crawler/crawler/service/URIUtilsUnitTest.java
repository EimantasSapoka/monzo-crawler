...
public class URIUtilsUnitTest {
    ...
    public void createUri_variousUrls_createsCorrectFormatterURIs() {
        ...
        Assertions.assertEquals(basePath + "/relative/path", URIUtils.createUri(basePath, "/relative/path/?testing").toString());
        ...
        Assertions.assertEquals(basePath.toString(), URIUtils.createUri(basePath, "#section").toString());
